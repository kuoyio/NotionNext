...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kuoyio', // 您的昵称 例如 tangly1024
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP备2020111542号-5', // 备案号
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://beian.miit.gov.cn/#/Integrated/index', // 备案查询链接
