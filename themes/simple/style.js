  ...
  return (
    <style jsx global>{`
      ...
      #theme-simple .simple-article-hero::after {
        ...
        border-radius: 50%;
        box-shadow:
          0 0 0 2rem rgba(15, 118, 110, 0.04),
          0 0 0 4rem rgba(15, 118, 110, 0.025);
      }
      ...
      #theme-simple .simple-article-kicker-mark {
        ...
        border-radius: 999px;
        background: #1677ff;
        box-shadow: 0 0 0 0.35rem rgba(22, 119, 255, 0.15);
      }
      ...
      #theme-simple .simple-article-lead-line {
        ...
        border-radius: 999px;
        background: linear-gradient(90deg, #1677ff, var(--article-accent));
      }
      ...
      #theme-simple .simple-article-content .notion blockquote {
        ...
        border-left: 0.25rem solid #1677ff;
      ...
      #theme-simple .simple-article-body-layout {
        display: grid;
      ...
      #theme-simple .simple-article-main {
        min-width: 0;
      }
      ...
      #theme-simple .simple-article-content #notion-article,
      #theme-simple .simple-article-content .notion-page-content,
      #theme-simple .simple-article-content .notion-page-content-inner {
        width: 100%;
        max-width: none;
      }
      ...
      #theme-simple .simple-article-content .notion .notion-callout,
      #theme-simple .simple-article-content .notion .notion-gray_background,
      #theme-simple .simple-article-content .notion .notion-code,
      #theme-simple .simple-article-content .notion .notion-toggle,
      #theme-simple .simple-article-content .notion .notion-to-do,
      #theme-simple .simple-article-content .notion .notion-bookmark {
        background: transparent;
      }
      ...
      #theme-simple .simple-article-toc {
        position: sticky;
        top: 2rem;
        min-width: 0;
        padding-top: 0.2rem;
      ...
      #theme-simple .simple-article-toc-heading {
        display: flex;
        align-items: center;
        gap: 0.55rem;
        color: var(--article-ink);
      ...
      #theme-simple .simple-article-toc-mark {
        width: 0.38rem;
        height: 0.38rem;
        border-radius: 999px;
        background: #1677ff;
      ...
      #theme-simple .simple-article-toc-list {
        margin: 1rem 0 0;
        padding: 0;
        border-left: 1px solid var(--article-border);
      }

      #theme-simple .simple-article-toc-link {
        display: block;
        overflow: hidden;
        padding-top: 0.35rem;
      ...
      #theme-simple .simple-article-toc-link:hover,
      #theme-simple .simple-article-toc-link.is-active {
      ...
      #theme-simple:has(.simple-article-page) #right-sidebar {
        display: none;
      }
      ...
      #theme-simple
        ...
        #nav-menu-pc
        .menu-link.simple-menu-link-active::after {
        position: absolute;
        right: 0;
        bottom: -0.5rem;
        left: 0;
      ...
      #theme-simple .simple-archive-post-grid {
        display: grid;
        grid-template-columns: 1fr;
        gap: 1rem;
      }

      #theme-simple .simple-archive-post-card {
        display: flex;
        width: 100%;
        height: 240px;
        min-width: 0;
      ...
      #theme-simple
        .simple-archive-post-card:hover
        .simple-archive-post-card-cover-link {
        width: 55%;
        flex-basis: 55%;
      }
      ...
      #theme-simple
        .simple-archive-post-card:hover
        .simple-archive-post-card-content {
        width: 45%;
        flex-basis: 45%;
      }

      #theme-simple .simple-archive-post-card-cover-link {
        display: block;
        flex: 0 0 50%;
        width: 50%;
        height: 100%;
      ...
      #theme-simple .simple-archive-post-card-cover {
        width: 100%;
        height: 100%;
      ...
      #theme-simple
        .simple-archive-post-card-cover-link:hover
        .simple-archive-post-card-cover {
        transform: scale(1.03);
      }

      #theme-simple .simple-archive-post-card-content {
        display: flex;
        flex: 0 0 50%;
        flex-direction: column;
        justify-content: space-between;
      ...
      #theme-simple .simple-archive-post-card-title-row {
        display: flex;
        align-items: flex-start;
        min-width: 0;
        gap: 0.5rem;
      ...
      #theme-simple .simple-archive-post-card-title {
        min-width: 0;
        overflow: hidden;
        color: #111;
        font-size: 1.25rem;
      ...
      #theme-simple .simple-archive-post-card-title:hover {
        color: #1677ff;
      }

      #theme-simple .simple-archive-post-card-lock {
        flex: 0 0 auto;
        padding-top: 0.35rem;
        color: #999;
        font-size: 0.75rem;
      ...
      #theme-simple .simple-archive-post-card-lock:hover {
        color: #1677ff;
      }

      #theme-simple .simple-archive-post-card-meta {
        display: grid;
        gap: 0.75rem;
        min-width: 0;
      }

      #theme-simple .simple-archive-post-card-meta-item {
        display: flex;
        align-items: center;
        min-width: 0;
        overflow: hidden;
      ...
      #theme-simple .simple-archive-post-card-meta-item i {
        flex: 0 0 1rem;
        width: 1rem;
        text-align: center;
      }

      #theme-simple .simple-archive-post-card-meta-item span {
        min-width: 0;
        margin-left: 4px;
        overflow: hidden;
        text-overflow: ellipsis;
      ...
      #theme-simple .simple-archive-empty {
        margin: 0;
        padding: 2rem 0;
        color: #888;
        font-size: 0.9rem;
      ...
      #theme-simple .simple-archive-post-card[id] {
        scroll-margin-top: 6rem;
      }
